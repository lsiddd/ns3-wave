...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-O0', '-ggdb', '-g3', '-Wall', '-std=c++11', '-Wno-parentheses', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CXX = ['/usr/bin/g++']
CXXDEFINES = ['_DEBUG']
CXXFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-std=c++11', '-Wno-parentheses', '-fstrict-aliasing', '-Wstrict-aliasing']
...
EXAMPLE_DIRECTORIES = ['udp-client-server', 'wireless', 'energy', 'socket', 'stats', 'routing', 'tutorial', 'realtime', 'naming', 'traffic-control', 'udp', 'tcp', 'matrix-topology', 'channel-models', 'ipv6', 'error-model']
...
NS3_EXECUTABLE_PATH = ['/home/lucas/git/ns-3-dev-git/build/src/fd-net-device', '/home/lucas/git/ns-3-dev-git/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-pc-linux-gnu/11.1.0/../../../../lib', '/home/lucas/git/ns-3-dev-git/build/lib', '/home/lucas/git/ns-3-dev-git/build']
...
cfg_files = ['/home/lucas/git/ns-3-dev-git/build/ns3/config-store-config.h', '/home/lucas/git/ns-3-dev-git/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
